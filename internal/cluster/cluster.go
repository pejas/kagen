...
type Manager interface {
	...
	EnsureResources(ctx context.Context, repo *git.Repository, d *devfile.Devfile) error
...
func (s *StubManager) EnsureResources(_ context.Context, _ *git.Repository, _ *devfile.Devfile) error {
